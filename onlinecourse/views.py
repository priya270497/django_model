...
from .models import Lesson, Instructor, Learner, Question, Choice, Submission
...
def show_exam_result(request, course_id, submission_id):
    ...
    for question in course.question_set.all():
        if set(question.correct_choices.values_list('id', flat=True)) == set(selected_ids.filter(question=question)):
